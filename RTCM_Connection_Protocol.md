...
Offset  Hex                                          ASCII
------  -------------------------------------------  -----------------
0x0000  49 4E 49 54 3A 52 4F 44 45 4E 30 31 3A 64  INIT:your_mountpoint:d
...
```python
# Send INIT command
auth_msg = "INIT:your_mountpoint:your_password*"
...
| **Protocol** | TCP |
| **Auth Command** | `INIT:your_mountpoint:your_password*` |
| **Auth Response** | `$HB$` |
