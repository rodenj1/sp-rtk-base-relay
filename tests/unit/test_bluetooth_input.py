...
class TestBluetoothConfig:
    ...
    def test_config_custom_values(self):
        ...
        config = BluetoothConfig(
            device_name="RTK_BASE_ROD",
            mac_address="98:D3:51:FE:FE:E4",
            auto_pair=False,
            adapter_name="hci1",
            scan_timeout=20,
        )
        
        assert config.device_name == "RTK_BASE_ROD"
        assert config.mac_address == "98:D3:51:FE:FE:E4"
...
class TestBluetoothInputSourceInit:
    ...
    def test_init_with_device_name(self):
        ...
        config = BluetoothConfig(device_name="RTK_BASE_ROD")
    ...
    def test_init_with_mac_address(self):
        ...
        config = BluetoothConfig(mac_address="98:D3:51:FE:FE:E4")
        source = BluetoothInputSource(config)
        
        assert source.config.mac_address == "98:D3:51:FE:FE:E4"
...
class TestBluetoothInputSourceConnection:
    ...
    def test_connect_success_with_device_name(self):
        ...
        mock_manager.ensure_device_ready.return_value = ("98:D3:51:FE:FE:E4", 1)
    ...
    def test_disconnect_closes_bluetooth_manager(self):
        ...
        mock_manager.disconnect_device.assert_called_once_with("98:D3:51:FE:FE:E4")
...
class TestBluetoothInputSourceInfo:
    ...
    def test_get_connection_info_disconnected(self):
        ...
        assert info["device_name"] == "RTK_BASE_ROD"
        assert info["mac_address"] == "98:D3:51:FE:FE:E4"
    ...
    def test_get_connection_info_connected(self):
        ...
        source = BluetoothInputSource(config)
        source._connected = True
        source.connected_mac = "98:D3:51:FE:FE:E4"
        source.rfcomm_channel = 1
        source.bt_socket = Mock()
        
        info = source.get_connection_info()
        
        assert info["connected_mac"] == "98:D3:51:FE:FE:E4"
    ...
    def test_get_bluetooth_statistics(self):
        ...
        assert stats["config"]["device_name"] == "RTK_BASE_ROD"
        assert stats["config"]["mac_address"] == "98:D3:51:FE:FE:E4"
        assert stats["connection"]["connected"] is True
        assert stats["connection"]["connected_mac"] == "98:D3:51:FE:FE:E4"
