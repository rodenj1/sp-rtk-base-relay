...
This setup connects your RTK GPS base station (RTK_BASE_ROD) via Bluetooth to your Raspberry Pi, creates a virtual serial port, and relays RTCM correction data to the custom RTCM server.

### Architecture

```
RTK_BASE_ROD (Bluetooth GPS)
    ↓ Bluetooth SPP
...
sp-base-relay (SerialInputSource)
    ↓ TCP/IP
RTCM Server (91.186.9.136:50010)
```
...
- Device Name: `RTK_BASE_ROD`
- MAC Address: `98:D3:51:FE:FE:E4`
...
[bluetooth]# scan on
# Wait until you see: Device 98:D3:51:FE:FE:E4 RTK_BASE_ROD
[bluetooth]# scan off
[bluetooth]# pair 98:D3:51:FE:FE:E4
# Enter PIN if prompted (common: 0000 or 1234)
[bluetooth]# trust 98:D3:51:FE:FE:E4
[bluetooth]# exit
```
...
bluetoothctl remove 98:D3:51:FE:FE:E4
bluetoothctl pair 98:D3:51:FE:FE:E4
bluetoothctl trust 98:D3:51:FE:FE:E4
...
bluetoothctl info 98:D3:51:FE:FE:E4 | grep Connected
...
hcitool con
hcitool rssi 98:D3:51:FE:FE:E4
```
