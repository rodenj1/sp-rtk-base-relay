...
echo ""
echo "Your Bluetooth GPS is ready for use with sp-base-relay!"
echo ""
echo "Next steps:"
echo "1. Update /etc/sp-base-relay/config.yaml to use serial input"
echo "2. Start bluetooth-gps service: sudo systemctl start bluetooth-gps"
echo "3. Start sp-base-relay service: sudo systemctl start sp-base-relay"
