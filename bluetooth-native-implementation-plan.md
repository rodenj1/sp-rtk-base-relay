...
class BluetoothConfig:
    device_name: str | None = None      # "RTK_BASE_ROD"
    mac_address: str | None = None      # "98:D3:51:FE:FE:E4"
...
**Deliverables:**
- Verified functionality with RTK_BASE_ROD GPS
...
**Mitigation:** Test with RTK_BASE_ROD  
...
4. **Hardware validation** with RTK_BASE_ROD
